"""
Django settings for the Educentric CLIENTS (parent & student) portal.

Shares the MySQL database with ADMINISTRATION. Portal models are unmanaged
so this app never alters tables owned by the admin system.
...
INSTALLED_APPS = [
    # Admin omitted: ADMINISTRATION owns auth users (employees_employee).
    "django.contrib.auth",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.portal.context_processors.portal_branding",
            ],
        },
    },
]
...
# Prefer MySQL when DB_NAME is set. Empty DB_PASSWORD is valid for local root.
...
PORTAL_LOGIN_REDIRECT_URL = "portal:dashboard"
...
SESSION_COOKIE_AGE = 60 * 60 * 8  # 8-hour school day session
